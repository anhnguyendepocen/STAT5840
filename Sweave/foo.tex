...
-43.043 -13.744  -1.892   9.671  36.509 

Coefficients:
            Estimate Std. Error t value Pr(>|t|)    
(Intercept)   1.2914     4.8720   0.265    0.792    
x             1.5090     0.1663   9.075  5.5e-12 ***
---
Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1 

Residual standard error: 16.97 on 48 degrees of freedom
Multiple R-squared: 0.6318,	Adjusted R-squared: 0.6241 
F-statistic: 82.36 on 1 and 48 DF,  p-value: 5.496e-12 
\end{Soutput}
\end{Schunk}
...
1     48 13819                              
2     47 12637  1   1181.74 4.3177 0.04333 *
3     46 12590  1     47.25 0.1726 0.67972  
---
Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1 
\end{Soutput}
\begin{Sinput}
...
\begin{Soutput}
  Res.Df      RSS Df Sum of Sq         F     Pr(>F)
1     48 13818.96 NA        NA        NA         NA
2     47 12637.22  1 1181.7437 4.3177388 0.04332509
3     46 12589.97  1   47.2479 0.1726297 0.67971699
\end{Soutput}
\end{Schunk}
...
\begin{tabular}{rrrrrrr}
 ...
 & Res.Df & RSS & Df & Sum of Sq & F & Pr($>$F) \\ 
  \hline
1 & 48 & 13818.96 &  &  &  &  \\ 
  2 & 47 & 12637.22 & 1 & 1181.74 & 4.318 & 0.043 \\ 
  3 & 46 & 12589.97 & 1 & 47.25 & 0.173 & 0.680 \\ 
   \hline
\end{tabular}
\end{center}
\end{table}
